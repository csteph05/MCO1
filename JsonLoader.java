...
public class JsonLoader {
     ...
     * creates a list of Plant objects to be used in the game.
     *
     * @param filename is the path to the JSON file containing the plant data
     * @return a list of fully initialized Plant objects
     */
    public static List<Plant> loadPlants(String filename) {
        ...
        try (Reader reader = new FileReader(filename)) {
            ...
            for (String plantId : entireJsonFile.keySet()) {
                ...
                // build the new Plant object with all the information
     ...
     * creates a list of Fertilizer objects to be used in the game.
     *
    ...
    /**
     * method that translates the Map JSON file into the 10x10 Field grid.
     ...
     * and loads them into the HighScoreManager
     *
     * @param filename path to the JSON file containing the high scores
     * @return a HighScoreManager object with the saved scores
     */

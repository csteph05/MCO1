...
public class Controller {
        ...
        for(Plant p : plants){
            if(player.canAfford((int)p.getSeedPrice())){
                ...
                System.out.println("[" + affordable.size() + "] "
                    ...
                    + " | Cost: " + p.getSeedPrice()
                    + " | Yield: " + p.getYield()
                    + " | Preferred Soil: " + p.getPreferredSoil());
            }
        }
     ...
     * Fertilizer list is loaded from JSON.
     */
            ...
            if (s != null) {
                ...
                if (s.isOccupied()){
                    ...
                    if (wasMature) {
                        ...
                        player.addSavings((int) value);
                        System.out.println("Plant at (" + coord[0] + "," + coord[1] + ") was matured and harvested!");
                    } else {
                        // immature plants are destroyed completely.
                        System.out.println("Plant at (" + coord[0] + "," + coord[1] + ") was destroyed!");
                    }
                }

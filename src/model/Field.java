...
public class Field {
    ...
    /**
     * This is the constructor that creates an instance of the model.Field class.
     ...
     * @return the model.Soil object at the specified location
     */
     ...
     * @param row the row index
     * @param col the col index
     * @param soil the model.Soil object to set at the specified location
     */
     ...
     *
     * @return 2D array of model.Soil objects.
     */
